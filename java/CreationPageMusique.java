...
public class CreationPageMusique{
    ...
    public static void generer(){
        ...
        File f = new File("../var/www/html/Video/Musique");

        tabNomVideo = f.list();


  		try{ 
            pw = new PrintWriter ( new File ( "../var/www/html/Musique.html" ), "utf-8" ); 
        ...
        for(String tmp : tabNomVideo){
            ...
            "\t\t\t\t\t<source src=\"./Video/Musique/"+ tmp + "\" type=\"video/mp4\"/>\n"+
            "\t\t\t\t\t<source src=\"./Video/Musique/"+ tmp + "\" type=\"video/ogg\"/>\n"+
